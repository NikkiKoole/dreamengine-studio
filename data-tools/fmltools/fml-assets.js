...
//
//   node data-tools/fmltools/fml-assets.js <file.fml> [options]      bake every furniture refid in the fml
//   node data-tools/fmltools/fml-assets.js --refids <a,b,c> [options] bake specific refids (quick test)
//
// options:
...
if (!opt.in && !opt.refids) {
  console.error('usage: node data-tools/fmltools/fml-assets.js <file.fml> [--max N] [--palette p] [--outline[=N]] [--posterize N] [--limit N]');
  process.exit(1);
}
