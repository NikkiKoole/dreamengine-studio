...
//
//   node data-tools/fmltools/fml-textures.js --json data/floorplan/<id>.json
...
if (!opt.json) { console.error('usage: node data-tools/fmltools/fml-textures.js --json <data.json> [--out dir] [--tile N]'); process.exit(1); }
