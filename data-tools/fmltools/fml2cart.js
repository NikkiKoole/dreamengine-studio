...
//
//   node data-tools/fmltools/fml2cart.js <file.fml> [--out tools/carts/floorwalker.c]
...
if (!argv.length || argv[0].startsWith('-')) {
  console.error('usage: node data-tools/fmltools/fml2cart.js <file.fml> [--out <cart.c>] [--scale N] [--floor i] [--design i] [--stdout]');
  process.exit(1);
}
...
let c = '';
c += `/* >>>FML_DATA   generated by data-tools/fmltools/fml2cart.js from ${path.basename(opt.in)} @ ${opt.scale}mm/px — do not hand-edit */\n`;
c += `#define LV_W ${W}\n#define LV_H ${H}\n`;
