...
- **EDITOR PATCH-MATCH DROP UI** (2026-09-11). Option A of the patch-matching fork: drop a WAV on
  ...
  chosen `instrument()` block into the open cart buffer. No engine change, no `studio.h` growth,
...
- **BLEND TABLES — index-only translucency, glow, fog and carve** (2026-07-10). `blend(BLEND_AVG /
  ...
  now one call, and **21 carts** call it. [ADR-0031](decisions/0031-blend-tables-before-palette.md) is the
