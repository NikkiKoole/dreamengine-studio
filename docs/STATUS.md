...
- **The worldgen ladder, rungs 0–3 — the realistic-roadgen foundation** (2026-07-06, all four in
  ...
  **`runtime/citygen.h`** (behaviour-preserving) — **sloop's M key drives a generated CITY**
  ...
  metres, projected; a `spec()` 11/0 added first as the render net). **Next:** B4 grade dispatch →
  roadlab interchanges (real highway junctions) + Rung 6 junction emission + the N+M infinite-world
  reconciliation (worldgen-plan rung 5.5).
