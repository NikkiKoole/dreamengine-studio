...
22. **Mobile-web readiness** *(new 2026-06-05, born from the live gallery + first
    ...
    and ~~gallery input badges~~ (`build-site.js` requires `lint()` and stamps an
    emoji chip per card — 👆 phone-ready / 👉 tap to play / ⌨ desktop only /
    👀 watch; `fixable` shows as desktop-only until touchControls lands). Still
