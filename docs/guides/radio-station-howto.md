...
3. **Whatever the genre wants that we lack is your new recipe** — usually the most valuable
   ...
   had used.)
4. **Blocked on an effect we don't have** (wah, reverb, chorus, leslie, tape, compression)?
   Note it — don't fake it badly. Pattern: [`../design/afrobeat-effects-wants.md`](../design/afrobeat-effects-wants.md),
   roster: [`../design/sound-next-steps.md`](../design/sound-next-steps.md) §effects.
...
6. **If voices were effects-blocked** (Phase 2.4): write/extend an effects-wants note
   ([`../design/afrobeat-effects-wants.md`](../design/afrobeat-effects-wants.md) is the model).
