...
const sections = [
  ...
  { title: 'midi',         keys: ['midi_get', 'midi_held', 'midi_bend', 'midi_present', 'midi_name', 'midi_cc', 'midi_cc_get'] },
  { title: 'host params',  keys: ['param_bind', 'param_count'] },
  { title: 'midi out',     keys: ['midi_send_note', 'midi_send_cc', 'midi_send_bend', 'midi_send_clock', 'midi_send_start', 'midi_send_stop', 'midi_out_ready'] },
  { title: 'sync',         keys: ['sync_active', 'sync_playing', 'sync_transport', 'sync_beats', 'sync_bpm'] },
  ...
  { title: 'sound',       keys: ['sfx', 'note', 'hit', 'note_on', 'note_off', 'note_pitch', 'note_vol', 'note_cutoff', 'note_duty', 'note_pan', 'note_res', 'note_lfo', 'note_lfo_shape', 'note_env', 'note_follow', 'note_harmonics', 'note_timbre', 'note_morph', 'voice_nasal', 'voice_consonant', 'voice_coda', 'instrument_mode', 'note_aux', 'note_drive', 'note_drive_mode', 'instrument_sync', 'note_sync', 'note_echo', 'note_reverb', 'note_filter', 'note_glide', 'note_glide_scale', 'instrument_glide', 'instrument_glide_scale', 'instrument_trigger', 'GLIDE_CONSTANT', 'GLIDE_ANALOG', 'GLIDE_PER_OCT', 'TRIG_MULTI', 'TRIG_SINGLE', 'note_retrig', 'note_off_all', 'instrument', 'instrument_duty', 'instrument_pan', 'instrument_level', 'export_audio', 'export_busy', 'export_progress', 'export_last', 'EXPORT_WAV', 'EXPORT_M4A', 'record_arm', 'record_grab', 'instrument_sample', 'instrument_sample_region', 'instrument_sample_mode', 'sample_peaks', 'sample_read', 'sample_load', 'sample_autotune', 'sample_shift', 'record_peaks', 'instrument_playhead', 'mic_start', 'mic_stop', 'mic_active', 'mic_level', 'mic_pitch', 'mic_record', 'mic_recording', 'mic_record_progress', 'mic_record_rate', 'mic_record_read', 'pan_law', 'listener', 'listener_vel', 'spatial_model', 'spatial_speed', 'note_pos', 'note_motion', 'hit_at', 'instrument_pos', 'instrument_motion', 'instrument_lfo', 'lfo_shape', 'lfo_value', 'scope_read', 'scope_read2', 'instrument_filter', 'instrument_keytrack', 'instrument_env', 'instrument_follow', 'instrument_harmonics', 'instrument_timbre', 'instrument_morph', 'instrument_tune', 'instrument_unison', 'instrument_unison_detune', 'instrument_drive', 'instrument_drive_mode', 'instrument_bandlimit', 'instrument_echo', 'instrument_reverb', 'instrument_reverb_bus', 'reverb_bus_fx', 'reverb_insert', 'reverb_spring', 'reverb_spring_tone', 'reverb_plate', 'reverb_plate_width', 'echo_insert', 'echo_insert_bbd', 'drive_insert', 'drive_insert_inst', 'drive_voice', 'grains', 'instrument_grains', 'grains_freeze', 'instrument_grains_freeze', 'grains_pitch', 'instrument_grains_pitch', 'instrument_chorus', 'instrument_flanger', 'instrument_tape', 'instrument_wah', 'instrument_wah_lfo', 'instrument_crush', 'instrument_eq', 'instrument_formant', 'instrument_tremolo', 'instrument_autopan', 'instrument_ringmod', 'instrument_ringmod_ratio', 'instrument_phaser', 'instrument_univibe', 'instrument_leslie', 'instrument_choke', 'echo', 'reverb', 'reverb_bus', 'chorus', 'flanger', 'tape', 'tape_inst', 'wah', 'wah_lfo', 'crush', 'crush_inst', 'eq', 'eq_inst', 'formant', 'filter', 'filter_inst', 'tremolo', 'autopan', 'ringmod', 'ringmod_ratio', 'phaser', 'univibe', 'leslie', 'dropout', 'shallow', 'instrument_shallow', 'amp_noise', 'gate', 'instrument_gate', 'multiband', 'instrument_multiband', 'shimmer', 'instrument_shimmer', 'varispeed', 'fx_mod', 'instrument_fx_mod', 'fx_lfo', 'fx_order', 'sidechain', 'sidechain_key', 'glue', 'vocoder', 'vocoder_send', 'vocoder_mic', 'vocoder_unvoiced', 'autotune_mic', 'harmonize_mic', 'input_monitor', 'wave_set', 'tone', 'chord', 'strum', 'strum_notes', 'schedule', 'schedule_hit', 'bpm', 'beat', 'beat_pos', 'every', 'euclid', 'chance', 'degree', 'INSTR_SQUARE', 'INSTR_SAW', 'INSTR_TRI', 'INSTR_NOISE', 'INSTR_SINE', 'INSTR_USER0', 'INSTR_USER1', 'INSTR_USER2', 'INSTR_USER3', 'INSTR_PLUCK', 'INSTR_MALLET', 'INSTR_FM', 'INSTR_ORGAN', 'INSTR_EPIANO', 'INSTR_PD', 'INSTR_MEMBRANE', 'INSTR_REED', 'INSTR_PIPE', 'INSTR_VOICE', 'INSTR_GUITAR', 'INSTR_PIANO', 'INSTR_BOWED', 'INSTR_BRASS', 'INSTR_SAMPLE', 'INSTR_MODAL', 'INSTR_FM4', 'SAMPLE_NORMAL', 'SAMPLE_REVERSE', 'SAMPLE_LOOP', 'SAMPLE_PINGPONG', 'LFO_PITCH', 'LFO_DUTY', 'LFO_VOLUME', 'LFO_CUTOFF', 'LFO_CUTOFF_OCT', 'LFO_HARMONICS', 'LFO_TIMBRE', 'LFO_MORPH', 'LFO_PAN', 'LFO_DETUNE', 'PAN_LINEAR', 'PAN_POWER', 'ENV_CUTOFF', 'ENV_CUTOFF_OCT', 'ENV_PITCH', 'ENV_DUTY', 'ENV_HARMONICS', 'ENV_TIMBRE', 'ENV_MORPH', 'ENV_DETUNE', 'FILTER_OFF', 'FILTER_LOW', 'FILTER_HIGH', 'FILTER_BAND', 'FILTER_NOTCH', 'FILTER_LADDER', 'FILTER_STEINER', 'FILTER_STEINER_HP', 'FILTER_STEINER_BP', 'FILTER_STEINER_NF', 'FILTER_DIODE', 'DRIVE_SOFT', 'DRIVE_HARD', 'DRIVE_FOLD', 'DRIVE_ASYM', 'DRIVE_VOICE_NONE', 'DRIVE_VOICE_TS', 'DRIVE_VOICE_RAT', 'DRIVE_VOICE_MUFF', 'LFO_SHAPE_SINE', 'LFO_SHAPE_SQUARE', 'LFO_SHAPE_TRI', 'LFO_SHAPE_SAW', 'LFO_SHAPE_RAMP', 'LFO_SHAPE_OPTICAL', 'LFO_SHAPE_SH', 'LFO_SHAPE_RANDOM', 'TREM_SINE', 'TREM_SQUARE', 'TREM_TRI', 'MODE_STRING_WEIGHT', 'MODE_STRING_CLICK', 'MODE_PIANO_DECAY', 'MODE_PIANO_KNOCK', 'MODE_PIANO_STRETCH', 'MODE_PIANO_STIFF', 'MODE_ORGAN_PERC_THIRD', 'MODE_ORGAN_PERC_SLOW', 'MODE_ORGAN_LEAK', 'MODE_BOW_PIZZ', 'MODE_BOW_BODY', 'MODE_BOW_SIZE', 'MODE_MODAL_POS', 'MODE_MODAL_DIRECT', 'MODE_MODAL_MODES', 'MODE_MODAL_EXCITE', 'MODE_MODAL_MAP', 'MODE_FM4_ALG', 'MODE_FM4_R0', 'MODE_FM4_R1', 'MODE_FM4_R2', 'MODE_FM4_R3', 'MODE_FM4_MAP', 'BOW_SIZE_VIOLIN', 'BOW_SIZE_VIOLA', 'BOW_SIZE_CELLO', 'BOW_SIZE_BASS', 'FX_TREM', 'FX_WAH', 'FX_CHORUS', 'FX_PHASER', 'FX_FLANGER', 'FX_TAPE', 'FX_EQ', 'FX_CRUSH', 'FX_REVERB', 'FX_FORMANT', 'FX_FILTER', 'FX_PAN', 'FX_RINGMOD', 'FX_ECHO', 'FX_GRAINS', 'FX_DRIVE', 'FX_SHALLOW', 'FX_GATE', 'FX_MULTIBAND', 'FX_INST', 'FXMOD_FILTER_CUT', 'FXMOD_FILTER_RES', 'FXMOD_DRIVE', 'FXMOD_TREM_DEPTH', 'FXMOD_PAN_DEPTH', 'FXMOD_GRAINS_MIX', 'FXMOD_SHIMMER_MIX', 'LESLIE_STOP', 'LESLIE_SLOW', 'LESLIE_FAST', 'SCALE_MAJOR', 'SCALE_MINOR', 'SCALE_PENTA', 'SCALE_PENTA_MIN', 'SCALE_BLUES', 'SCALE_CHROMATIC', 'CHORD_MAJ', 'CHORD_MIN', 'CHORD_DIM', 'CHORD_AUG', 'CHORD_MAJ7', 'CHORD_MIN7', 'CHORD_DOM7', 'CHORD_SUS4', 'CHORD_POWER'] },
  { title: 'utility', keys: ['rnd', 'rnd_between', 'rnd_float', 'rnd_float_between', 'rnd_seed', 'now', 'dt', 'epoch', 'frame', 'fps', 'sgn', 'mid', 'timer', 'timer_reset'] },
  { title: 'persistence', keys: ['save', 'load', 'save_int', 'load_int', 'save_bytes', 'load_bytes', 'de_state', 'de_state_for', 'de_state_for_saved', 'STATE', 'S', 'GameState'] },
  ...
  { title: 'screen',       keys: ['SCREEN_W', 'SCREEN_H', 'screen_w', 'screen_h', 'canvas_resize', 'safe_rect', 'finger_px', 'device_class'] },
