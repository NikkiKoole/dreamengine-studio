...
const sections = [
  ...
  { title: 'sound',       keys: ['sfx', 'note', 'hit', 'note_on', 'note_off', 'note_pitch', 'note_vol', 'note_cutoff', 'note_duty', 'note_pan', 'note_res', 'note_lfo', 'note_env', 'note_follow', 'note_harmonics', 'note_timbre', 'note_morph', 'note_drive', 'note_echo', 'note_filter', 'note_glide', 'note_off_all', 'instrument', 'instrument_duty', 'instrument_pan', 'instrument_lfo', 'instrument_filter', 'instrument_env', 'instrument_follow', 'instrument_harmonics', 'instrument_timbre', 'instrument_morph', 'instrument_tune', 'instrument_drive', 'instrument_echo', 'instrument_choke', 'echo', 'wave_set', 'tone', 'chord', 'strum', 'schedule', 'schedule_hit', 'bpm', 'beat', 'beat_pos', 'every', 'euclid', 'chance', 'degree', 'INSTR_SQUARE', 'INSTR_SAW', 'INSTR_TRI', 'INSTR_NOISE', 'INSTR_SINE', 'INSTR_USER0', 'INSTR_USER1', 'INSTR_USER2', 'INSTR_USER3', 'INSTR_PLUCK', 'INSTR_MALLET', 'INSTR_FM', 'INSTR_ORGAN', 'INSTR_EPIANO', 'INSTR_PD', 'INSTR_MEMBRANE', 'INSTR_REED', 'INSTR_PIPE', 'INSTR_GUITAR', 'INSTR_PIANO', 'LFO_PITCH', 'LFO_DUTY', 'LFO_VOLUME', 'LFO_CUTOFF', 'LFO_HARMONICS', 'LFO_TIMBRE', 'LFO_MORPH', 'LFO_PAN', 'ENV_CUTOFF', 'ENV_PITCH', 'ENV_DUTY', 'ENV_HARMONICS', 'ENV_TIMBRE', 'ENV_MORPH', 'FILTER_OFF', 'FILTER_LOW', 'FILTER_HIGH', 'FILTER_BAND', 'FILTER_NOTCH', 'SCALE_MAJOR', 'SCALE_MINOR', 'SCALE_PENTA', 'SCALE_PENTA_MIN', 'SCALE_BLUES', 'SCALE_CHROMATIC', 'CHORD_MAJ', 'CHORD_MIN', 'CHORD_DIM', 'CHORD_AUG', 'CHORD_MAJ7', 'CHORD_MIN7', 'CHORD_DOM7', 'CHORD_SUS4', 'CHORD_POWER'] },
