...
const sections = [
  ...
  { title: 'graphics',   titleNL: 'tekenen',      keys: ['cls', 'colorkey', 'spr', 'sprf', 'sspr', 'spr_rot', 'sspr_ex', 'pget', 'pset', 'print', 'print_centered', 'print_right', 'print_scaled', 'text_width', 'rect', 'rectfill', 'bar', 'circ', 'circfill', 'oval', 'ovalfill', 'tri', 'trifill', 'tritex', 'line', 'camera', 'camera_ex', 'follow', 'clip', 'pal', 'pal_reset', 'fade', 'shake'] },
