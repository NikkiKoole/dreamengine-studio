...
const sections = [
  ...
  { title: 'mouse',         keys: ['mouse_x', 'mouse_y', 'mouse_world_x', 'mouse_world_y', 'mouse_down', 'mouse_pressed', 'mouse_released', 'mouse_wheel', 'MOUSE_LEFT', 'MOUSE_RIGHT', 'MOUSE_MIDDLE', 'mouse_cursor', 'CURSOR_DEFAULT', 'CURSOR_HAND', 'CURSOR_CROSSHAIR', 'CURSOR_MOVE', 'CURSOR_TEXT', 'CURSOR_NO', 'CURSOR_RESIZE_H', 'mouse_hide', 'mouse_show'] },
