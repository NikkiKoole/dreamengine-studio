...
void note_glide(int handle, int ms);                      // portamento: make note_pitch slide over `ms` instead of snapping (0 = snap); even in semitones, and `ms` is a rate not an exact duration
