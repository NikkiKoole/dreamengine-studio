...
#define INSTR_BOWED   28  // bowed string — violin/cello/viola. A Smith/McIntyre stick-slip friction waveguide; self-oscillates and HOLDS while sustained (like a real bow). Speaks with an attack scratch and swells. macros: harmonics = bow position (sul ponticello bright → sul tasto soft), timbre = bow pressure (clean leaning-sawtooth → scratchy surface), morph = bow speed/swell (gentle → digging in, louder + cleaner)
