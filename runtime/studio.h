...
#define INSTR_SAMPLE  30  // PCM sample playback — plays a RECORDED buffer (record_arm/record_grab capture the console's own output) back at pitch on a keybed. Bind a buffer with instrument_sample(); press the root note for original speed, higher = faster/up. One-shot forward for now (mic-and-sampling.md)
