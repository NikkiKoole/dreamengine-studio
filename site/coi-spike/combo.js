...
var findStringEnd = (heapOrArray, idx, maxBytesToRead, ignoreNul) => {
  ...
  function _emscripten_thread_sleep(ms) {}
...
var ASM_CONSTS = {
  26192: () => { if (document.fullscreenElement) return 1; },  
 26238: () => { return document.getElementById('canvas').width; },  
 26290: () => { return parseInt(document.getElementById('canvas').style.width); },  
 26358: () => { document.exitFullscreen(); },  
 26385: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 26458: () => { if (document.fullscreenElement) return 1; },  
 26504: () => { return document.getElementById('canvas').width; },  
 26556: () => { return screen.width; },  
 26581: () => { document.exitFullscreen(); },  
 26608: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 26741: () => { return window.innerWidth; },  
 26767: () => { return window.innerHeight; },  
 26794: () => { if (document.fullscreenElement) return 1; },  
 26840: () => { return document.getElementById('canvas').width; },  
 26892: () => { return parseInt(document.getElementById('canvas').style.width); },  
 26960: () => { if (document.fullscreenElement) return 1; },  
 27006: () => { return document.getElementById('canvas').width; },  
 27058: () => { return screen.width; },  
 27083: () => { return window.innerWidth; },  
 27109: () => { return window.innerHeight; },  
 27136: () => { if (document.fullscreenElement) return 1; },  
 27182: () => { return document.getElementById('canvas').width; },  
 27234: () => { return screen.width; },  
 27259: () => { document.exitFullscreen(); },  
 27286: () => { if (document.fullscreenElement) return 1; },  
 27332: () => { return document.getElementById('canvas').width; },  
 27384: () => { return parseInt(document.getElementById('canvas').style.width); },  
 27452: () => { document.exitFullscreen(); },  
 27479: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 27537: () => { return screen.width; },  
 27562: () => { return screen.height; },  
 27588: () => { return window.screenX; },  
 27615: () => { return window.screenY; },  
 27642: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 27695: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 27766: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 27823: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 28079: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
...
function assignWasmExports(wasmExports) {
  _resume_audio = Module['_resume_audio'] = wasmExports['resume_audio'];
