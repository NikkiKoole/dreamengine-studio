...
// build-history.js: derives everything from the same data cart-index.js uses — each
// cart's teaches[] / lineage in editor/public/carts/index.json (categories + colours
// come from tools/teaches-vocab.js) — so it's a reproducible artifact of the tag data,
// not hand-maintained. Re-run after re-tagging or adding tagged carts.
//
...
<div class="wrap">
  ...
  <footer>
    Generated by <code>tools/build-compendium.js</code> from each cart's <code>teaches</code> / <code>lineage</code>
    in <code>editor/public/carts/index.json</code>. <code>teaches</code> is a controlled vocabulary (<code>tools/teaches-vocab.js</code>), hard-validated by <code>lint-carts.js</code>.
  </footer>
</div>
