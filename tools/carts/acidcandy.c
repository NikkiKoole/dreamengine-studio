...
static void r2_mstsweep(Box b) {
    ...
    int tx = (int)m.x;
    if (lcdbtnf(0x2D8u, &tx, (int)m.y, (int)m.h - 1, mswmode ? "PHS" : "FLG", 1)) mswmode = !mswmode;
    static const char *RB[3] = { "1BAR", "2BAR", "4BAR" };
