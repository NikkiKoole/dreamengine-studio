/* de:meta
{
  ...
  "todo": [
    "VOCODER REWIRE (design/air-effects-wants.md): vocoder(mix) + vocoder_send(slot,amt) shipped 2026-07-17, but Kelly's robot lead is still a raw INSTR_VOICE vowel. Point a broadband SAW/pulse chord at the carrier and vocoder_send the INSTR_VOICE line as modulator - that is the whole remaining AIR want."
  ],
