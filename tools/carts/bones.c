/* de:meta
{
  ...
  "todo": [
    "Use a smaller font so body parts can be written less cryptically.",
    "Lost the way to change the rig — Tab should surface that on-screen; add a little help panel.",
    "Needs work to be pleasant; promising as a tool but not for now."
  ]
}
de:meta */
#include "studio.h"
