/* de:meta
{
  ...
  "todo": [
    "ui-audit: the soldier-name labels (PVT JONES/SMITH/WUI/BROWN/DUTCH) overlap each other and run off the right edge; the control hint overlaps \"SQUAD: 5 FALLEN: 0\"."
  ]
}
de:meta */
#include "studio.h"
