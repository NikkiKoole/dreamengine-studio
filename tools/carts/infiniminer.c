/* de:meta
{
  ...
  "todo": [
    "Rotation feels wrong — you end up looking at the inside of the voxels/boxes constantly.",
    "Dislike the current dithering; consider truetype colors to tint the blocks better."
  ]
}
de:meta */
#include "studio.h"
