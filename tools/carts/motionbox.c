/* de:meta
{
  ...
  "todo": [
    ...
    "OSC / WAVEFORM (timbre) select per synth part - the 'MMT' heart of the EMX (many oscillator models); motionbox has fixed instrument recipes. IN TENSION with the scarcity soul (wants a 5th per-part concept / a WAVE knob) - decide whether it earns the extra surface or stays a second, deeper Electribe cart."
  ],
  "description": {
