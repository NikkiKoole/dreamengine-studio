/* de:meta
{
  ...
  "todo": [
    "Some overflowing text — use a smaller font where needed.",
    "Nice game — a candidate to grow further.",
    "ui-audit: the \"3 seasons: EERSTE DIVISIE - EREDIVISIE - EUROPE\" banner runs off both edges."
  ]
}
de:meta */
#include "studio.h"
