 ...
 *
 *   clang -O2 tools/clips/fm4op/render-nr.c runtime/studio.c runtime/raylib_compat.c \
 ...
 *         -lm -lpthread -o build/fm4op-nr-script
 *   build/fm4op-nr-script 180 tools/clips/fm4op/01-tine.script out.wav
 *
 * Or: bash tools/clips/fm4op/render-nr.sh [/opt/cursor/artifacts]
 *
